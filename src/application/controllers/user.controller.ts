 ...
 //if (page > totalPages)
  ...
  updateUser = async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (updates.email) {
        const exists = await this.repository.isExists(updates.email, undefined, id);
  ...
  resendOtpCode = async (req: Request, res: Response) => {
    ...
    try {
      ...
      const otpResponse: SendOtpResponse = await this.otpService.sendVerificationMessage(user.phoneNumber, otpCode);
  ...
  deleteUserAccount = async (req: Request, res: Response) => {
    ...
    try {
      ...
      const user = await this.repository.findOne({ phoneNumber }, selectPassword);
