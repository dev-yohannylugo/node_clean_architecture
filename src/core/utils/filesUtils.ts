...
const moveFiles = async (oldDirPath: string, newDirPath: string): Promise<boolean> => {
  try {
...
const createDirectory = async (path: string, recursive: boolean): Promise<boolean> => {
  try {
...
const renameDir = async (oldPath: string, newPath: string): Promise<boolean> => {
  try {
